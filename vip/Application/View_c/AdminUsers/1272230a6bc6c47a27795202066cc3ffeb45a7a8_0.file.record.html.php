<?php
/* Smarty version 3.1.29, created on 2016-05-17 23:26:00
  from "/mnt/data/www/web/team16/vip/Application/View/Admin/Users/record.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_573b38084d8a15_05015565',
  'file_dependency' => 
  array (
    '1272230a6bc6c47a27795202066cc3ffeb45a7a8' => 
    array (
      0 => '/mnt/data/www/web/team16/vip/Application/View/Admin/Users/record.html',
      1 => 1463498713,
      2 => 'file',
    ),
  ),
...
function content_573b38084d8a15_05015565 ($_smarty_tpl) {
?>
                    ...
                    <form method="post" action="index.php?p=Admin&c=Histories&a=list">
                        <tr>
                            ...
                            <div class="tags" style="margin-bottom:20px;">
                                <div id="tagstitle">
                                    <a id="one1" onclick="setTab('one',1,6)" class="hover">消费记录</a>
                                </div>
                        </tr>
                    </form>
                    ...
                    <div id="tagscontent" class="right_box">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" name="table1" id="table1" width="100%">
                            ...
                            <tr class="th">
                                ...
                                <th align="center"><!--userid-->流水号</th>
                                <th align="center"><!--username-->会员名字</th>
                                <th align="center"><!--nickname-->服务员工</th>
                                <th align="center"><!--groupid-->类型</th>
                                <th align="center"><!--groupid-->本次金额</th>
                                <th align="center"><!--groupid-->消费内容</th>
                                <th align="center"><!--groupid-->消费时间</th>
...
?>
                            ...
                            <tr class="s_out">
                                ...
                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['row']->value['history_id'];?>
</td>
                                <td align="center" style="padding-left:10px;"><?php echo $_smarty_tpl->tpl_vars['row']->value['user_id'];?>
</td>
                                <td align="center" style="padding-left:10px;"><?php echo $_smarty_tpl->tpl_vars['row']->value['member_id'];?>
</td>
                                <td align="center" style="padding-left:10px;"><?php echo $_smarty_tpl->tpl_vars['row']->value['type'];?>
</td>
                                <td align="center" style="padding-left:10px;"><?php echo $_smarty_tpl->tpl_vars['row']->value['amount'];?>
</td>
                                <td align="center" style="padding-left:10px;"><?php echo $_smarty_tpl->tpl_vars['row']->value['content'];?>
</td>
                                <td align="center" style="padding-left:10px;"><?php echo $_smarty_tpl->tpl_vars['row']->value['time'];?>
</td>
                                <td align="center" style="padding-left:10px;"><?php echo $_smarty_tpl->tpl_vars['row']->value['remainder'];?>
</td>
...
?>
                        ...
                        <div class="page"><span>&nbsp;&nbsp; &nbsp;&nbsp;总共1页&nbsp;&nbsp;当前第1页
                                 <a href="index.php?p=Admin&c=Histories&a=show&$pageIndex=1">第一页</a>
                                <a href="index.php?p=Admin&c=Histories&a=show&pageIndex=1">上一页</a>
                                <a href="index.php?p=Admin&c=Histories&a=show&pageIndex=1">下一页</a>
                                <a href="index.php?p=Admin&c=Histories&a=show&pageIndex=1">最后页</a>
                            </span>
